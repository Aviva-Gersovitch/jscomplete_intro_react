//ReactDOM.render() and React.createElement() are the core API methods in a React application

//The below code shows why React is intelligent when it comes to updating any existing view on the DOM
//The time string is ticking every second because of the setInterval function below.
//However, if you try to type something into the text box, only the React version intelligently changes only the pre element and not the whole DOM tree
